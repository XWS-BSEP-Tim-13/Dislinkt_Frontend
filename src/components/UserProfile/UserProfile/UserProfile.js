                ...
                ProfileCover / > {
                    ...
                    /div> {
                        ...
                        />} {
                            ...
                            toggleAddExperience = { toggleAddExperienceModal }
                            userId = { user.id }
                            reload = { reload }
                            />} {
                                user.educations && < Educations educations = { user.educations }
                                toggleAddEducation = { toggleAddEducationModal }
                                userId = { user.id }
                                reload = { reload }
                                />} {
                                    user.skills && < Skills skills = { user.skills }
                                    toggleAddSkill = { toggleAddSkillModal }
                                    userId = { user.id }
                                    reload = { reload }
                                    />} {
                                        ...
                                        />} {
                                            ...
                                            reload = { reload }
                                            />} {
                                                addEducationVisible && < AddEducation toggleAddEducation = { toggleAddEducationModal }
                                                user = { user }
                                                reload = { reload }
                                                />} <
                                                /div> <
                                                ...
                                                {
                                                    addSkillVisible && < AddSkill toggleAddSkill = { toggleAddSkillModal }
                                                    user = { user }
                                                    reload = { reload }
                                                    />} <
                                                    /div>
